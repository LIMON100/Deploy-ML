...
if __name__ == '__main__':
    ...
    torch.onnx.export(model, sample_input, "ssd2.onnx", export_params=True, input_names=input_nodes, output_names=output_nodes)

    # Converting model to Tensorflow

    onnx_model = onnx.load("ssd2.onnx")
    ...
    open("b2.tflite", "wb").write(tflite_model)
